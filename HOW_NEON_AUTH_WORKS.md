...
Create and manage your own users table to store user information in your database.
Implement synchronization logic to keep this users table in sync with your authentication provider. This includes handling user creation and, crucially, user updates and deletions.
Create a todos table that references your users table using a foreign key.
